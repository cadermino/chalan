  ...
  <div>
    <div class="flex flex-wrap my-10">
      <div class="w-full mb-4 max-w-xl mx-auto">
        ...
        <p>&nbsp;</p>
        <p>
          La presente Política de Privacidad establece los términos en que Chalán usa
          y protege la
        ...
        <p>
          ...
          y mejorar nuestros productos y servicios. Es posible que sean enviados correos
          electrónicos
          ...
          brindarle algún
          beneficio,
          estos correos electrónicos serán enviados a la dirección que usted proporcione
          y podrán ser
          cancelados en cualquier momento.
        </p>
        <p>
          Chalán está altamente comprometido para
          cumplir con
          el
        ...
        <p>
          ...
          permiso para
          almacenarse en su ordenador, al aceptar dicho fichero se crea y la cookie
          sirve entonces para
          tener información respecto al tráfico web, y también facilita las futuras
          visitas a una web
          recurrente.
        ...
        <p>
          ...
          estadístico y después
          la información se elimina de forma permanente. Usted puede eliminar las cookies en
          cualquier momento
          desde su ordenador. Sin embargo las cookies ayudan a proporcionar un mejor servicio
          de los sitios web,
          estás no dan acceso a información de su ordenador ni de usted, a menos de que usted
          así lo quiera y
          la proporcione directamente, visitas a una web. Usted puede aceptar o negar el uso
          de cookies,
          sin embargo la mayoría de navegadores aceptan cookies automáticamente pues sirve para
          tener un mejor
        ...
        <p>
          ...
          sobre al sitio al que es redirigido y por lo tanto no somos responsables de
          los términos o
          privacidad ni de la protección de sus datos en esos otros sitios terceros.
          Dichos sitios
          están
          sujetos a sus propias políticas de privacidad por lo cual es recomendable
          que los consulte para
        ...
        <p>
          ...
          o el uso de la información personal
        ...
        <p>
          ...
          que es recopilada sin su
          consentimiento, salvo que sea requerido por un juez con un orden judicial.
        </p>
        <p>
          Chalán Se reserva el derecho de cambiar los términos de la presente Política de
          Privacidad
