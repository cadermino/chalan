      ...
      <div className="container mx-auto px-6 py-16 max-w-3xl">
        ...
        <div className="space-y-6 text-gray-700 leading-relaxed">
          <p>
            ...
            con los términos de este documento. Sin embargo este Aviso de
          ...
          <p>
            Chalán está altamente comprometido para cumplir con el compromiso de
          ...
          <p>
            ...
            de usuario, puede marcar o desmarcar la opción de recibir información
          ...
          <p>
            Chalán se reserva el derecho de cambiar los términos del presente
